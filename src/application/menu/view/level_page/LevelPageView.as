package application.menu.view.level_page
{
	...
	public class LevelPageView implements IPage{
					
		private var menuStage:			Sprite;			
		private var linkToTable:		MovieClip;		
		private var tween:				TweenLite;		
		
		public function LevelPageView(_menuStage:Sprite){
		...
		public function show():void{
			...
			var elementClass:Class = ApplicationDomain.currentDomain.getDefinition(LevelPageVariables.TABLE_CLASS_NAME) as Class;
